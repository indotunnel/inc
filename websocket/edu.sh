...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/indotunnel/inc/main/setup/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/indotunnel/inc/main/setup/edu-op.py
